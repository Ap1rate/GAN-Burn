...
def get_transform(opt, params=None, grayscale=False, method=transforms.InterpolationMode.BICUBIC, convert=True):
    """
    Create a transform pipeline for images.

    Args:
        opt: options
        params: random crop/flip params
        grayscale: set True if target domain images are single-channel (e.g., pseudo-thermal map)
    """
